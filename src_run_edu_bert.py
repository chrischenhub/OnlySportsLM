...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, default="Chrisneverdie/sports-text-classifier")
    parser.add_argument("--dataset_name", type=str, default="Chrisneverdie/sports-annotation-test")
    parser.add_argument("--dataset_config", type=str, default="default")
    parser.add_argument("--output_dataset_name", type=str, default="output/annotated_sports")
